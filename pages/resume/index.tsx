...
const Resume: NextPage = () => {
  ...
  const handleViewFullPage = () => {
    ...
    window.open('/Vrushab complete resume.pdf', '_blank');
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/Vrushab complete resume.pdf';
    link.download = 'Vrushab complete resume.pdf';
        ...
        <CardContent className="p-0">
          <div className="relative bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden">
            ...
            {hasError ? (
              ...
              <iframe
                src="/Vrushab complete resume.pdf"
                width="100%"
                height="800"
